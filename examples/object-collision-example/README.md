...
Supported shape types in the parser: `rectangle`, `circle`, `capsule`, `polygon`.
...
All 10 shape-pair combinations are fully supported (including capsule-vs-everything).
